...
type ClientService interface {
	...
	GetSingleProduct(params *GetSingleProductParams, opts ...ClientOption) (*GetSingleProductOK, error)
...
/*
  GetSingleProduct Return a single product from the database
*/
func (a *Client) GetSingleProduct(params *GetSingleProductParams, opts ...ClientOption) (*GetSingleProductOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetSingleProductParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getSingleProduct",
		Method:             "GET",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetSingleProductReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*GetSingleProductOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getSingleProduct: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
  UpdateProduct Update the details of a product
*/
